...
class MessageAdmin(admin.ModelAdmin):
    list_display = ['message_id', 'sender', 'conversation', 'sent_at', 'edited', 'edited_by', 'read', 'parent_message']
    list_filter = ['sent_at', 'conversation', 'edited', 'read']
    search_fields = ['sender__email', 'message_body']
    readonly_fields = ['message_id', 'sent_at']
    raw_id_fields = ['sender', 'conversation', 'parent_message', 'edited_by']
...
class MessageHistoryAdmin(admin.ModelAdmin):
    list_display = ['history_id', 'message', 'edited_at', 'edited_by']
